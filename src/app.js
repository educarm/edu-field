...
app.controller('appController', ['$scope','$http', function ($scope,$http) {
     ...
     $scope.fields=[
					...
					{key: 'fecha',type: 'date',col:'col-md-4',lines: 5,inputSize:'sm',label:'Fecha',placeholder: 'Fecha',autofocus:'',required: true,showButtonCalendar:true,format:'dd/MM/yyyy',disabled:false,readonly:false}, 
