...
app.controller('appController', ['$scope','$http', function ($scope,$http) {
     ...
     $scope.fields=[
					...
					{key: 'upload',type: 'upload',multiple:true,showprogressbar:true,showbuttons:true,url:"/api/v1/upload",col:'col-md-12',label: 'Subida fichero',placeholder: 'Upload',autofocus:'' },
